...
<div class="container">
	...
	<!-- end -->
	<?php
		$result2=$conn->query("SELECT tennhomsp FROM nhomsp WHERE idnhomsp={$idgroup}");
		while($row2 = $result2->fetch_assoc())
		{
			$groupname=$row2['tennhomsp'];
		}
	?>
	<div class="main-block col-lg-9 col-md-9 col-sm-9 col-xs-12">
		<p class="title col-lg-12 col-md-12 col-sm-12 col-xs-12"><?php echo $groupname; ?></p>
			<?php
				$result1=$conn->query("SELECT * FROM sanpham WHERE idnhomsp={$idgroup}");
